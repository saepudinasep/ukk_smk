...
<body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="riwayat_siswa.php">History Pembayaran</a></li>
    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php
                $nisn = $profil['nisn'];
                $sqlBayar = mysqli_query($konek, "SELECT tb_pembayaran.*, tb_siswa.*
                                                  FROM tb_pembayaran
                                                  INNER JOIN tb_siswa ON tb_siswa.nisn=tb_pembayaran.nisn
                                                  WHERE tb_pembayaran.nisn='01234'
                                                  ORDER BY tb_pembayaran.jatuh_tempo ASC");
                $no=1;
                $total = 0;
                while ($d=mysqli_fetch_array($sqlBayar)) {
                    $qpetugas = mysqli_query($konek, "SELECT * FROM tb_petugas WHERE id_petugas='$d[id_petugas]'");
