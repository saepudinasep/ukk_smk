...
<div class="container">
    ...
    <form action="" method="post">
        <table class="table">
            <tr>
                <td>Kelas</td>
                <td><input class="form-control" type="number" name="kelas"></td>
            </tr>
            <tr>
                <td>Kompetensi Keahlian</td>
                <td><input class="form-control" type="text" name="keahlian"></td>
            </tr>
            <tr>
                <td>Wali Kelas</td>
                <td>
                    <select class="form-control" name="id_guru">
                        ...
                        ?>
                        <option value="<?php echo $dguru['id_guru']; ?>">
            ...
            <tr>
                ...
                <a class="btn btn-info" href="tampil_kelas.php">Kembali</a>
                  </td>
            </tr>
        </table>
    </form>
    ...
    <?php 
        if ($_SERVER['REQUEST_METHOD']=='POST') {
            ...
            if ($kelas=='' || $keahlian=='') {
                ...
                $simpan = mysqli_query($konek, "INSERT INTO tb_kelas (nama_kelas, kompetensi_keahlian, id_guru)
                 VALUES('$kelas', '$keahlian', '$id_guru')");
                 if (!$simpan) {
