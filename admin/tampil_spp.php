...
<div class="container">
    ...
    <a class="btn btn-primary" style="margin-bottom: 10px;" href="tambah_spp.php">Tambah Data</a>
    <table class="table table-bordered table-striped">
        ...
        <?php 
            $sql = mysqli_query($konek, "SELECT * FROM tb_spp ORDER BY tahun ASC");
            $no=1;
            ...
            <tr>
                ...
                <td width='60px'>";
                ?>
                    <a onclick="return confirm('Anda akan menghapusnya?')" title="Hapus" href="hapus_spp.php?id=<?php echo $d['id_spp']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a> |
                    <a title="Edit" href="edit_spp.php?id=<?php echo $d['id_spp']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                <?php
                echo "</td>
            </tr>";
            $no++;
