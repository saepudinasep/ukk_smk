...
<div class="container">
    ...
    <table class="table table-bordered table-striped">
        ...
        <?php 
            $sql = mysqli_query($konek, "SELECT * FROM tb_guru ORDER BY id_guru ASC");
            $no=1;
            ...
            <tr>
                ...
                <td width='60px'>";
                ?>
                    <a onclick="return confirm('Anda akan menghapusnya?')" title="Hapus" href="hapus_guru.php?id=<?php echo $d['id_guru']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a> |
                    <a title="Edit" href="edit_guru.php?id=<?php echo $d['id_guru']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                <?php
                echo "</td>
            </tr>";
            $no++;
