...
<body>
    ...
    <?php
        $id = $_GET['id'];
        $sqlEdit = mysqli_query($konek, "SELECT * FROM tb_petugas WHERE id_petugas='$id'");
    ...
    <div class="container">
        ...
        <form action="" method="post">
            <table class="table">
                <tr>
                    <td>Nama Petugas</td>
                    <td><input class="form-control" type="text" name="nama" value="<?php echo $e['nama_petugas']; ?>"></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                ...
                <tr>
                    ...
                    <input class="btn btn-success" type="submit" value="Simpan">  
                        <a class="btn btn-info" href="tampil_petugas.php">Kembali</a>
                    </td>
                </tr>
            </table>
        </form>
