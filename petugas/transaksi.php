                                ...
                                <tr>
                                    ...
                                    <td align='center'>";
                                        if($d['tgl_bayar']==''){
                                            ...
                                            echo "
                                            <a class='btn btn-danger' href='proses_transaksi.php?nisn=$nisn&act=batal&id=$d[id_spp]&bulan=$d[bulan]'>Batal</a>
                                            <a class='btn btn-default' href='cetak_slip_transaksi.php?nisn=$nisn&id=$d[id_spp]&bulan=$d[bulan]' target='_blank'>Cetak</a>
                                            ";
                                        }
                                    echo "</td>
                                </tr>";
